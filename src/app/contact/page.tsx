...
export default function ContactPage() {
    return (
        <div className="min-h-screen bg-black text-white pt-[30vh] pb-20 px-6 md:px-12 font-sans">
            ...
            <div className="grid md:grid-cols-12 gap-12 md:gap-y-32">
                ...
                <div className="md:col-span-3">
                    <motion.h2
                        ...
                        className="text-xs font-bold uppercase tracking-widest text-white/50 sticky top-32"
                    >
                        Contact Info
                    </motion.h2>
                </div>
                        ...
                        <div key={agency.region} className="grid md:grid-cols-2 gap-8 md:gap-0 border-t border-white/10 pt-8 md:pt-0 md:border-none">
                            ...
                            >
                                ...
                                <div className="space-y-1 text-sm">
                                    {agency.phone && <p className="text-white/70">{agency.phone}</p>}
                                    <a href={`mailto:${agency.email}`} className="block text-white hover:text-white/50 transition-colors">
                                        {agency.email}
                                    </a>
                                </div>
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wider hover:text-white/50 transition-colors border-b border-white pb-0.5"
                                >
                                    {agency.website}
            ...
            <div className="mt-32 pt-12 border-t border-white/20 grid md:grid-cols-12 gap-12">
                <div className="md:col-span-3">
                    <span className="text-xs font-bold uppercase tracking-widest text-white/50">Inquiries</span>
                </div>
                <div className="md:col-span-9 grid md:grid-cols-2">
                    <div className="md:col-start-2 space-y-4">
                        ...
                        <a href="mailto:kangquintusfilms@gmail.com" className="text-xl font-bold hover:text-white/50 transition-colors block">
            ...
            <div className="mt-32 flex justify-between items-end text-[10px] uppercase tracking-widest text-white/30">
